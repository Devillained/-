...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(992, 670)
        self.centralwidget = QtWidgets.QWidget(MainWindow)
        self.centralwidget.setObjectName("centralwidget")

        self.field_text = QtWidgets.QTextEdit(self.centralwidget)
        self.field_text.setStyleSheet("background-color: rgb(194, 194, 202);\n"
                                      "font: 8pt \"MV Boli\";")
        self.field_text.setObjectName("field_text")

        self.listWidget = QtWidgets.QListWidget(self.centralwidget)
        self.listWidget.setStyleSheet("background-color: rgb(194, 194, 202);\n"
                                       "font: 8pt \"MV Boli\";")
        self.listWidget.setObjectName("listWidget")

        self.listWidget_2 = QtWidgets.QListWidget(self.centralwidget)
        self.listWidget_2.setStyleSheet("background-color: rgb(194, 194, 202);\n"
                                        "font: 8pt \"MV Boli\";")
        ...
        self.button_tag_search.setStyleSheet("")
    ...
    def _add_layout(self):
        ...
        layout.addWidget(self.field_text, 0, 0, 1, 2)
        layout.addWidget(self.list_notes_label, 1, 0)
        layout.addWidget(self.label_2, 1, 1)
        layout.addWidget(self.listWidget, 2, 0)
        layout.addWidget(self.listWidget_2, 2, 1)
        layout.addWidget(self.button_note_create, 3, 0)
        layout.addWidget(self.button_note_del, 3, 1)
        layout.addWidget(self.button_note_save, 4, 0)
        layout.addWidget(self.button_tag_search, 4, 1)
        layout.addWidget(self.field_tag, 5, 0)
        layout.addWidget(self.button_tag_add, 5, 1)
        layout.addWidget(self.button_tag_del, 6, 1)
